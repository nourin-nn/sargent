...
author: "Nima Nouri and Katherine Norwood"
...
Sargent can be installed from Bioconductor:
...
Such ambiguous calls remain unclassified and are relabeled as `TBD`s.
...
consensus on their labels, the surrounding cell will be relabeled according to
...
`sargent` contains a pair of stand-alone functions to investigate the
...
of signature genes (`TBD`s) and the higher mode represents those with high
